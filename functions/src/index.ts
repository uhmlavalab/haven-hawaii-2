...
//Key
function startKeyUpload(uid: string, portfolio: string): Promise<boolean> {
...
function uploadKeyData(data: any, uid: string, portfolio: string): Promise<boolean> {
  const keyData = [];
...
function keyDataBatchUpload(keyData: any, uid: string, portfolio: string): Promise<boolean> {
  if (keyData.length <= 0) {
    return Promise.resolve(true);
  }
...
//Capacity 
function startCapacityUpload(uid: string, portfolio: string): Promise<boolean> {
...
function uploadCapacityData(data: any, uid: string, portfolio: string): Promise<boolean> {
  const capData = [];
  const columns = arrayToLowerCase(data[0]);
...
function capacityDataBatchUpload(capData: any, uid: string, portfolio: string): Promise<boolean> {
  if (capData.length <= 0) {
    return Promise.resolve(true);
  }
...
// Load
function startLoadUpload(uid: string, portfolio: string): Promise<boolean> {
...
function uploadLoadData(data: any, uid: string, portfolio: string): Promise<boolean> {
  const loadData = [];
  const columns = arrayToLowerCase(data[0]);
...
function loadDataBatchUpload(loadData: any, uid: string, portfolio: string): Promise<boolean> {
...
//Profile
function startProfileUpload(uid: string, portfolio: string): Promise<boolean> {
...
function uploadProfileData(data: any, uid: string, portfolio: string): Promise<boolean> {
  const profileData = [];
...
function profileDataBatchUpload(profileData: any, uid: string, portfolio: string): Promise<boolean> {
...
function arrayToLowerCase(input): string {
