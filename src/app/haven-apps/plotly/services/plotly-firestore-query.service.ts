...
export class PlotlyFirestoreQueryService {
  ...
  constructor(private loadedPortfolioService: LoadedPortfolioService, private afs: AngularFirestore, private afAuth: AngularFireAuth) {}
  ...
  private getLoad(startDate: Date, endDate: Date, value: string): Promise<any> {
    return this.loadedPortfolioService.portfolioDatabaseRef
      .collection('load')
